...
from graphs.retriever_io import RetrieverInput
...
if __name__ == "__main__":
    ...
    df = df[:100]
    loader = DataFrameLoader(df, page_content_column="상품명")
    splitter = None
    embeddings = OpenAIEmbeddings()
    vector_store = FAISS

    chain = BaseRetrieverChain(loader, splitter, vector_store, embeddings)
