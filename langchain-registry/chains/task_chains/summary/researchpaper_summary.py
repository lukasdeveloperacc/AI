...
class ResearchPaperSummaryChain(Runnable[SummaryChainInput, str]):
    ...
    def _make_preprocess_chain(self, base_64_str: str = None, file_path: str = None, **kwargs) -> Runnable:
        from chains.preprocess_chains import PDFChain
        ...
        chain = PDFChain(vector_store=vector_store, loader=loader, splitter=splitter, embdding=embedding)
