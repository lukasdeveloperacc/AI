...
from segmentation.unet.config.trainer.config import UnetTrainerConfig
...
class TrainConfig(BaseModel):
    mode: str = "train"
    dataset: dict[str, BaseDatasetConfig | MVTecDatasetConfig | AnotherDatasetConfig] | MVTecDatasetConfig = MVTecDatasetConfig()
    ...
    trainer: dict[str, UnetTrainerConfig]
...
class TestConfig(BaseModel):
    mode: str = "test"
    dataset: dict[str, MVTecDatasetConfig] | MVTecDatasetConfig = MVTecDatasetConfig()
    network: dict[str, UnetConfig] | UnetConfig = UnetConfig()
    trainer: dict[str, UnetTrainerConfig]
    loss: dict[str, Optional[CrossEntropyLossConfig]] | CrossEntropyLossConfig = CrossEntropyLossConfig()
